...
```{r sisikin-recap-models, eval = FALSE, cache = FALSE, warning=FALSE}
...
```{r siskin-model-plots, fig.width=7, eval = FALSE,echo = FALSE, fig.cap='Standard type 3 and 5 moult models fitted to the Siskin dataset without considering within-season recaptures converge at biased parameter estimates (red lines and polygons). When recapture information is included in the model, the resulting fits (green lines and polygons) better encapsulate the observed data.'}
...
```{r ind-intercepts,eval = FALSE, fig.width = 7, fig.caption = 'There is good agreement between the simulated individual start dates and their estimates in both the type 3r and type 5R models.'}
