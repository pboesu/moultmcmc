...
stanmodels <- c("uz12_linpred", "uz1_linpred", "uz1_simple", "uz2_linpred", "uz2_simple", "uz3_linpred", "uz4_linpred", "uz5_linpred")

# load each stan module
Rcpp::loadModule("stan_fit4uz12_linpred_mod", what = TRUE)
Rcpp::loadModule("stan_fit4uz1_linpred_mod", what = TRUE)
Rcpp::loadModule("stan_fit4uz1_simple_mod", what = TRUE)
Rcpp::loadModule("stan_fit4uz2_linpred_mod", what = TRUE)
Rcpp::loadModule("stan_fit4uz2_simple_mod", what = TRUE)
