...
stanmodels <- c("uz12_linpred", "uz1_linpred", "uz2_linpred", "uz2_recap", "uz2_recap_mk2", "uz3_linpred", "uz3_recap", "uz4_linpred", "uz4_recap", "uz5_linpred", "uz5_recap")
...
Rcpp::loadModule("stan_fit4uz2_recap_mk2_mod", what = TRUE)
