...
stanmodels <- c("uz12_linpred", "uz1_linpred", "uz2_linpred", "uz2_lumped", "uz2_recap", "uz3_linpred", "uz3_recap", "uz4_linpred", "uz5_linpred", "uz5_recap", "uz5_recap_annual_raneff")
...
Rcpp::loadModule("stan_fit4uz2_lumped_mod", what = TRUE)
